...
build:
	...
	eval ${BIN} lint --fix --ignore test --extension .json --resolve ${VERSION} -x top_level_examples -x top_level_description -x simple_properties_identifiers -x orphan_definitions -x description_trailing_period *.json ./${VERSION}
